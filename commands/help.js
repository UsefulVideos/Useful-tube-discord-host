...
module.exports = {
    ...
    execute(message, args) {
       ...
       const Embed = new Discord.RichEmbed().setTitle('PresentBot Help').setDescription('Welcome to the list of commands!').addField('**Regular Commands**', `${prefix}ping \n${prefix}avatar \n${prefix}beep \n${prefix}prefix \n${prefix}server \n${prefix}hug \n${prefix}say <content> \n${prefix}user-info \n${prefix}help \n${prefix}ban <reason> (BOT OWNER ONLY) \n${prefix}kick <reason> (BOT OWNER ONLY) \n${prefix}renamebot (BOT OWNER ONLY)`, null).addBlankField().addField('**Random Commands**', `${prefix}quack \n${prefix}holographic \n${prefix}hello \n${prefix}options`, `In case of issues, please contact the bot owner. Thank you for reading!`);
